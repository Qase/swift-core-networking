...
class TokenClientLiveTests: XCTestCase {
    ...
    func test_default_current_token_success() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                Just(testToken).setFailureType(to: TokenPersistanceError.self)
    ...
    func test_default_current_token_failure() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                Fail(error: TokenPersistanceError.loadTokenError)
                    .handleEvents(receiveSubscription: { _ in
                        loadTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
    ...
    func test_default_current_token_validation_failure() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                Just(.init(value: "localToken")).setFailureType(to: TokenPersistanceError.self)
                    .handleEvents(receiveSubscription: { _ in
                        loadTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
    ...
    func test_wait_for_current_token_when_refreshing() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                Just(testToken)
                    .setFailureType(to: TokenPersistanceError.self)
                    .handleEvents(receiveSubscription: { _ in
                        loadTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
    ...
    func test_multiple_refresh_requests_cause_single_refresh_call() {
        ...
        tokenClient = TokenClientLive(
            ...
            storeToken: { newToken in
                Just(()).setFailureType(to: TokenPersistanceError.self)
                    .handleEvents(receiveSubscription: { _ in
                        storeTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
    ...
    func test_refresh_token_failure() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                ...
                Fail(error: TokenError.refreshError)
                    .handleEvents(receiveSubscription: { _ in
                        refreshTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
    ...
    func test_store_token_failure() {
        ...
        tokenClient = TokenClientLive(
            loadToken: {
                ...
                Fail(error: TokenPersistanceError.storeTokenError)
                    .handleEvents(receiveSubscription: { _ in
                        storeTokenCount += 1
                    })
                    .delay(for: 1, scheduler: self.testScheduler)
